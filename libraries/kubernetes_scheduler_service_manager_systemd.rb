module KubernetesCookbook
  class KubernetesSchedulerServiceManagerSystemd < KubernetesSchedulerServiceBase
    use_automatic_resource_name

    # TODO: if using systemd
    provides :kubernetes_scheduler_service_manager
    ...
    action :create do
      ...
      template '/lib/systemd/system/kube-scheduler.service' do
        source 'lib/systemd/system/kube-scheduler.service.erb'
        owner 'root'
        group 'root'
        mode '0644'
        variables(
    ...
    action :start do
      service 'kube-scheduler' do
        ...
        action [:enable, :start]
        only_if { ::File.exist?('/lib/systemd/system/kube-scheduler.service') }
      end
    end
